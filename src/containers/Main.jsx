        ...
        style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
         <div className="title">Kirill Rybkov</div>
          <div className="text">
              ...
              <p>&nbsp; Now working in web3 & blockchain space after working in game dev for a year. Built a lot of cool stuff during hackathons. I do believe that blockchain is the future of more sustainable capitalism without corruption, crimes and stupid policies that will one day help the humans to hugely expand.</p>
              <p>&nbsp; I prefer working as a back-end developer, however I can do front-end.</p>
              </span>
          </div> 
          <div className='icons'>
              < FaGithub />
